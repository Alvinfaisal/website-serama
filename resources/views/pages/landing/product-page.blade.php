    ...
    <section class="bg-gray-100 py-8 px-4">
        <div class="container mx-auto">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="#" aria-label="current-page">All produk</a>
                </li>
            </ul>
        </div>
    </section>
        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-wrap -m-4">
                ...
                @forelse ($products as $product)
                    <div class="lg:w-1/4 md:w-3/12 p-4 w-full">
                        <a href="{{ route('landing.details', $product->slug) }}"
                        ...
                        <div class="mt-4">
                            ...
                            <p class="mt-1">IDR {{ number_format($product->price) }}</p>
                        </div>
                    </div>
                @empty
                    {{-- empty --}}
