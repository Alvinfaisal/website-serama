            ...
            <div class="flex flex-col items-center justify-center">
                <div class="w-full md:w-4/12 text-center">
                    ...
                    <p class="text-lg mb-12">
                        Terimakasi pesanan kamu sedang kami proses
                    </p>
                    <a href="{{ route('landing.index') }}"
                        class="text-white bg-green-200 focus:outline-none w-full py-3 rounded-full text-lg focus:text-black transition-all duration-200 px-8 cursor-pointer">
