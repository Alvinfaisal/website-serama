    ...
    <section class="flex items-center hero">
        ...
        <div class="w-full inset-0 md:relative md:w-1/2">
            <div class="relative hero-image">
                ...
                <img src="{{ asset('/frontend/images/content/bg-heros.svg') }}" alt="hero 1"
        ...
        <div class="container mx-auto mb-4">
            <div class="flex justify-center text-center mb-4">
                <h3 class="text-2xl capitalize font-semibold">
                    Produk Terbaru <br class="" />
                    <p class="text-sm">Ayam serama berkualitas</p>
                </h3>
            </div>
        </div>
            ...
            <div class="flex -mx-4 flex-row relative">
                ...
                <div class="px-4 relative card group">
                    <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                        ...
                        <img src="/frontend/images/content/serama-7.svg" alt=""
                ...
                <div class="px-4 relative card group">
                    <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                        ...
                        <img src="/frontend/images/content/serama-6.svg" alt=""
                            class="w-full h-full object-cover object-center" />
                    </div>
                ...
                <div class="px-4 relative card group">
                    <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                        ...
                        <img src="/frontend/images/content/serama-5.svg" alt=""
                            class="w-full h-full object-cover object-center" />
                    </div>
