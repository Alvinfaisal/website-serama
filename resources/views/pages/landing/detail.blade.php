        ...
        <div class="flex flex-wrap my-4 md:my-12">
            ...
            <div class="flex-1">
                <div class="slider">
                    <div class="thumbnail">
                        <div class="px-2">
                            <div class="item selected" data-img="/frontend/images/content/serama-1.svg">
                                <img src="/frontend/images/content/serama-1.svg" alt="front"
                                    class="object-cover w-full h-full rounded-lg" />
                            </div>
                        </div>
                        <div class="px-2">
                            <div class="item" data-img="/frontend/images/content/serama-2.svg">
                                <img src="/frontend/images/content/serama-2.svg" alt="back"
                                    class="object-cover w-full h-full rounded-lg" />
                            </div>
                        </div>
                        <div class="px-2">
                            <div class="item" data-img="/frontend/images/content/serama-3.svg">
                                <img src="/frontend/images/content/serama-3.svg" alt="rear"
                                    class="object-cover w-full h-full rounded-lg" />
                            </div>
                        </div>
                        <div class="px-2">
                            <div class="item" data-img="/frontend/images/content/serama-4.svg">
                                <img src="/frontend/images/content/serama-4.svg" alt="side"
                                    class="object-cover w-full h-full rounded-lg" />
                            </div>
                        </div>
                        <div class="px-2">
                            <div class="item" data-img="/frontend/images/content/serama-5.svg">
                                <img src="/frontend/images/content/serama-5.svg" alt="top"
                                    class="object-cover w-full h-full rounded-lg" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex-1 px-4 md:p-6">
                ...
                <a href="cart.html"
                    class="transition-all duration-200 bg-green-200 text-black focus:bg-black focus:text-pink-400 rounded-full px-8 py-3 mt-4 inline-flex"><svg
        ...
        <div class="container mx-auto">
            <div class="flex flex-start mb-4">
                <h3 class="text-2xl capitalize font-semibold">
                    Ayam berkualitas <br class="" />Rekomendasi kami
                </h3>
            </div>
            <div class="flex overflow-x-auto mb-4 -mx-3">
                <div class="px-3 flex-none" style="width: 320px">
                    <div class="rounded-xl p-4 pb-8 relative bg-white">
                        <div class="rounded-xl overflow-hidden card-shadow w-full h-full">
                            <img src="/frontend/images/content/serama-1.svg" alt=""
                ...
                <div class="px-3 flex-none" style="width: 320px">
                    <div class="rounded-xl p-4 pb-8 relative bg-white">
                        <div class="rounded-xl overflow-hidden card-shadow w-full h-full">
                            <img src="/frontend/images/content/serama-2.svg" alt=""
                                class="w-full h-full object-cover object-center" />
                        </div>
                ...
                <div class="px-3 flex-none" style="width: 320px">
                    <div class="rounded-xl p-4 pb-8 relative bg-white">
                        <div class="rounded-xl overflow-hidden card-shadow w-full h-full">
                            <img src="/frontend/images/content/serama-3.svg" alt=""
                                class="w-full h-full object-cover object-center" />
                        </div>
                ...
                <div class="px-3 flex-none" style="width: 320px">
                    <div class="rounded-xl p-4 pb-8 relative bg-white">
                        <div class="rounded-xl overflow-hidden card-shadow w-full h-full">
                            <img src="/frontend/images/content/serama-4.svg" alt=""
                                class="w-full h-full object-cover object-center" />
                        </div>
