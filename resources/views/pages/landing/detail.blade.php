        ...
        <div class="flex flex-wrap my-4 md:my-12">
            ...
            <div class="flex-1 px-4 md:p-6">
                ...
                <form action="{{ route('cart-add', $product->id) }}" method="POST">
                    @csrf
                    <button
                        class="transition-all duration-200 bg-green-200 text-white focus:bg-black focus:text-pink-400 rounded-full px-8 py-3 mt-4 inline-flex"><svg
                ...
                @foreach ($recommendations as $recommendation)
                    <div class="px-3 flex-none" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-white">
                            ...
                            <a href="{{ route('landing.details', $recommendation->slug) }}" class="stretched-link">
                                <!-- fake children -->
                            </a>
                        </div>
                    </div>
