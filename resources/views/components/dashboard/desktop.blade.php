                    ...
                    <template x-if="isPagesMenuOpen">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            ...
                            <li
                                ...
                                <a class="w-full" href="{{ route('dashboard.articles.index') }}">Daftar
                                    Artikel</a>
                            </li>

                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="{{ route('dashboard.tags.index') }}">
                                    Tambah Tag
                                </a>
                            </li>
                            ...
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="{{ route('dashboard.categories.index') }}">
                                    Tambah Kategori
                                </a>
                            </li>
                        </ul>
