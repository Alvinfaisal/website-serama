 <!-- START: ASIDE MENU -->
 <section class="">
     <div class="bg-serama text-white border-t border-b border-gray-200 py-12 mt-16 px-4">
         ...
         <aside class="container mx-auto">
             <div class="flex flex-wrap -mx-4 justify-center">
                 ...
                 <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                     <h5 class="text-lg font-semibold mb-2 relative">Get In Touch</h5>
                     <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
                         <li>
                             <a href="#" class="hover:underline py-1 block">Instagram</a>
                         </li>
                         <li>
                             <a href="#" class="hover:underline py-1 block">Youtube</a>
                         </li>
                         <li>
                 ...
                 <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                     ...
                     <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
                         ...
                         <li>
                             <a href="#" class="hover:underline py-1 block">News Feed</a>
                         </li>
                         <li>
                             <a href="#" class="hover:underline py-1 block">Faq & Updates</a>
                         </li>
                     </ul>
                 </div>
                 <div class="px-4 w-full md:w-3/12 mb-4 md:mb-0">
                     ...
                     <form action="#">
                         <label class="relative w-full">
                             ...
                             <button class="absolute rounded-xl right-0 p-3" style="background-color: #009393">
 ...
 <!-- START: FOOTER -->
 <footer class="bg-serama text-white flex text-center px-4 py-8 justify-center">
     <p class="text-sm">
         Copyright 2021 • All Rights Reserved Serama's by Me
     </p>
 </footer>
 <!-- END: FOOTER -->
