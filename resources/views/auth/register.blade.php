        ...
        <div class="w-full md:w-1/3 flex flex-col">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 ">
                ...
                <a href="{{ route('landing.index') }}">
                    <img class="mt-4 pt-4" src="{{ asset('frontend/images/logo/logo-serama.svg') }}"
                ...
                <form method="POST" action="{{ route('register') }}" class="flex flex-col pt-3 md:pt-3">
                    ...
                    <button type="submit" class="bg-black text-white font-bold text-lg hover:bg-gray-700 p-2 mt-8 rounded-lg"
                        style="background-color: #016170" />
                    Register
                    </button>
                </form>
